...
from fixtures.base import BaseTestCase, AdminLoginTestCase, POMAdminLoginTestCase
...
class ReportCreate(POMAdminLoginTestCase):

    def setUp(self):
        super(ReportCreate, self).setUp()
    ...
    def tearDown(self):
        ...
        super(ReportCreate, self).tearDown()
